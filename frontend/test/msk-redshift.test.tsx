  ...
  test('Should hide the redshift and quicksight settings when not enable data processing', async () => {
    ...
    const dataProcessingDom = render(
      <DataProcessing
        ...
        s3TableBucketEmptyError={false}
        s3TableBucketArnFormatError={false}
        s3TablesNamespaceEmptyError={false}
        s3TablesScheduleFormatError={false}
        s3TablesDataRetentionError={false}
      />
    );
