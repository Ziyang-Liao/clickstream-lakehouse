...
import { S3TablesModelingStack } from './s3-tables-modeling-stack';
...
stackSuppressions([
  new S3TablesModelingStack(app, app.node.tryGetContext('s3TablesModelingStackName') ?? 's3-tables-modeling-stack', {
    synthesizer: synthesizer(),
  }),
], commonCdkNagRules);
